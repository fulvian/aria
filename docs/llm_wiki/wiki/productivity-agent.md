...
| Skill | Version | Description |
|-------|---------|-------------|
| `email-draft` | 1.0.0 | Bozze email con stile dinamico derivato runtime dalle conversazioni con il recipient. |
...
- 4 skill required (office-ingest, consultancy-brief, meeting-prep, planning-with-files)
