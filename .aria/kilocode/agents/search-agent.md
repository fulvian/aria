...
5. **Intent SOCIAL**: REDDIT è tier 1 ma richiede OAuth. Se REDDIT non è configurato (DOWN), scala a SEARXNG.
6. **scientific_papers** è keyless (bypassa Rotator). **pubmed** usa NCBI_API_KEY opzionale via CredentialManager.
